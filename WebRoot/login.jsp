                ...
                <div class="login-container">
                    <div class="center">
                        <h1>
                            ...
                            <span class="red"></span>
                            <span class="grey" id="id-text2">学生宿舍管理系统</span>
                        </h1>
                                        ...
                                        <fieldset>
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="username" name="username" type="text" class="form-control" placeholder="用户名" required autofocus oninvalid="setCustomValidity('请输入用户名')" oninput="setCustomValidity('')"/>
