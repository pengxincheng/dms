    ...
    <div class="main-content">
        <div class="main-content-inner fixed-page-header fixed-82">
            <div id="breadcrumbs" class="breadcrumbs">
                <ul class="breadcrumb">
                    <li class="active"><i class="fa fa-arrow-right"></i>调换宿舍</li>
                </ul><!-- /.breadcrumb -->
        ...
        <div class="main-content-inner padding-page-content">
            <div class="page-content">
                ...
                <div class="row">
                    <div class=" col-xs-12">
                        <form class="form-horizontal" role="form" id="addChangeRoom" name="addChangeRoom" action="addChangeRoom.do" method="post">
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control" id="targetRoom" name="targetRoom" data-validation-engine="validate[required]" onchange="getBuildingByAreaId()">
                                        ...
                                        <c:forEach var="room" items="${rooms }">
                                        	<option value="${room.roomSn}">${room.roomSn}</option>
                                        </c:forEach>
                                    </select>
                                </div>                                     
                            </div>
                            <div class="form-group">
                               <label class="col-sm-1 control-label no-padding-right" for="reasion">申请原因</label>
	                             <div class="col-sm-11">
	                                 <textarea class="form-control" id="reasion" name="reasion" placeholder="申请原因" style="width: 356px; height: 66px;"></textarea>
	                             </div>                                          
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#addChangeRoom").validationEngine({
