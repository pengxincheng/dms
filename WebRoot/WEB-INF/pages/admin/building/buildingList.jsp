    ...
    <div class="main-content">
        <div class="main-content-inner fixed-page-header fixed-40">
            <div id="breadcrumbs" class="breadcrumbs">
                <ul class="breadcrumb">
                    <li class="active"><i class="fa fa-arrow-right"></i>楼栋列表</li>
                </ul><!-- /.breadcrumb -->
            </div>
        </div>
                    ...
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" id="form1" action="index.html" method="post">
                            ...
                            <div class="page-toolbar align-right list-toolbar">
                                <button type="button" class="btn btn-xs btn-inverse btn-xs-ths" id="btnAdd" data-ths-href="goToBuildingAddPage">
                                        ...
                                        <table id="example" class="table table-striped  table-bordered table-hover">
                                            ...
                                            <tr>
                                               <th class="center">
                                                ...
                                                <th class="align-center">楼栋名称</th>
                                                <th class="align-center">宿舍区</th>
                                                <th class="align-center">宿舍管理员</th>
                                                <th class="align-center">可住人数</th>
