    ...
    <div class="main-content">
        ...
        <div class="main-content-inner padding-page-content">
            <div class="page-content">
                ...
                <div class="row">
                    <div class=" col-xs-12">
                        <form class="form-horizontal" role="form" id="addManager" name="addManager" action="addManager.do" method="post">
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="username">登录名</label>
                                <div class="col-sm-3">
                                    <input type="text" data-validation-engine="validate[required]" class="form-control" placeholder="名称" id="username" name="username"/>
                                </div> 
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" data-validation-engine="validate[required]" class="form-control" placeholder="名称" id="age" name="age"/>
                                </div> 
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    jQuery(function ($) {
        ...
        $("#btnSubmit").on(ace.click_event, function () {
            ...
            if ($('#addManager').validationEngine('validate')) {
                //submit
            }
        });
