    ...
    <div class="main-content">
        ...
        <div class="main-content-inner padding-page-content">
            <div class="page-content">
                ...
                <div class="row">
                    <div class=" col-xs-12">
                        <form class="form-horizontal" role="form" id="editManager" name="editManager" action="editManager.do" method="post">
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="username">登录名</label>
                                <div class="col-sm-3">
                                    <input type="text" data-validation-engine="validate[required]" class="form-control" placeholder="名称" id="username" name="username" value="${manager.username }"/>
                                </div> 
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="name">姓名</label>
                                <div class="col-sm-3">
                                    <input type="text" data-validation-engine="validate[required]" class="form-control" placeholder="名称" id="name" name="name" value="${manager.name }"/>
                                </div> 
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="age">年龄</label>
                                <div class="col-sm-3">
                                    <input type="text" data-validation-engine="validate[required,custom[number]]" class="form-control" placeholder="名称" id="age" name="age" value="${manager.age }"/>
                                </div> 
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                   <select class="form-control" id="gender" name="gender" data-validation-engine="validate[required]">
                                        ...
                                        <option ${manager.gender eq '男' ? 'selected' :''} value="男">男</option>
                                        <option ${manager.gender eq '女' ? 'selected' :''} value="女">女</option>
                                    </select>
                                </div>   
                            </div><div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="buildingId">管辖楼宇</label>
                                <div class="col-sm-3">
                            ...
                            <input type="hidden" value="${manager.userId }" name="userId" id="userId" />					
                        </form>
...
<!-- 自己写的JS，请放在这里 -->
<script type="text/javascript">
	getBuilding(${manager.buildingId});
    jQuery(function ($) {
        ...
        $("#btnSubmit").on(ace.click_event, function () {
            ...
            if ($('#editManager').validationEngine('validate')) {
                //submit
            }
        });
