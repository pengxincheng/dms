    ...
    <div class="main-content">
        <div class="main-content-inner fixed-page-header fixed-82">
            <div id="breadcrumbs" class="breadcrumbs">
                <ul class="breadcrumb">
                    <li class="active"><i class="fa fa-arrow-right"></i>考勤统计</li>
                </ul><!-- /.breadcrumb -->
            </div>
        </div>
...
var myChart1 = echarts.init(document.getElementById('main1'));
        // 指定图表的配置项和数据
myChart.showLoading();
$.get('censusRegisterByGrade.do',{type:"晚归"}).done(function (data) {
   myChart.hideLoading();
...
$.get('censusRegisterByGrade.do',{type:"缺勤"}).done(function (data) {
