    ...
    <div class="main-content">
        <div class="main-content-inner fixed-page-header fixed-82">
            <div id="breadcrumbs" class="breadcrumbs">
                <ul class="breadcrumb">
                    <li class="active"><i class="fa fa-arrow-right"></i>卫生检查</li>
                </ul><!-- /.breadcrumb -->
        ...
        <div class="main-content-inner padding-page-content">
            <div class="page-content">
                ...
                <div class="row">
                    <div class=" col-xs-12">
                        <form class="form-horizontal" role="form" id="addCheckHygiene" name="addCheckHygiene" action="addCheckHygiene.do" method="post">
                             <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="checkMan">检查人</label>
                                <div class="col-sm-3">
                                    <input type="text" data-validation-engine="validate[required]" class="form-control" placeholder="检查人" id="checkMan" name="checkMan"/>
                                </div>                                            
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control" id="roomId" name="roomId" data-validation-engine="validate[required]">
                                        ...
                                        <c:forEach var="room" items="${rooms }">
                                        	<option value="${room.roomId}">${room.roomSn}</option>
                                        </c:forEach>
                                    </select>
                                </div>                                          
                            </div>
							...
							<div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="describe">描述</label>
	                             <div class="col-sm-11">
	                                 <textarea data-validation-engine="validate[required]" class="form-control" id="describe" name="describe" placeholder="描述" style="width: 356px; height: 66px;"></textarea>
	                             </div>
                            </div>							
                        </form>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#addCheckHygiene").validationEngine({
        ...
        $("#btnSave").on(ace.click_event, function () {
            //console.log("validate begin..");
            //console.log($('#addNotify').validationEngine('validate'));
            if ($('#addCheckHygiene').validationEngine('validate')) {
            	alert("操作成功");
                $('#addCheckHygiene').submit();
            }
        });
