    ...
    <div class="main-content">
        ...
        <div class="main-content-inner padding-page-content">
            <div class="page-content">
                ...
                <div class="row">
                    <div class=" col-xs-12">
                        <form class="form-horizontal" role="form" id="addRegister" name="addRegister" action="addRegister.do" method="post">
                            <div class="form-group">
							 ...
							 <div class="form-group">
                            	 <label class="col-sm-1 control-label no-padding-right" for="reasion">晚归原因</label>
	                             <div class="col-sm-11">
	                                 <textarea data-validation-engine="validate[required]" class="form-control" id="reasion" name="reasion" placeholder="晚归原因" style="width: 356px; height: 66px;"></textarea>
	                             </div>
                            </div>		
                            <div class="form-group">
                            ...
                            <input type="hidden" id="type" name="type" value="晚归">							
                        </form>
