    ...
    <div class="main-content">
        <div class="main-content-inner fixed-page-header fixed-82">
            <div id="breadcrumbs" class="breadcrumbs">
                <ul class="breadcrumb">
                    <li class="active"><i class="fa fa-arrow-right"></i>缺勤登记</li>
                </ul><!-- /.breadcrumb -->
        ...
        <div class="main-content-inner padding-page-content">
            <div class="page-content">
                ...
                <div class="row">
                    <div class=" col-xs-12">
                        <form class="form-horizontal" role="form" id="addRegister" name="addRegister" action="addRegisterFroQueQin.do" method="post">
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="stuNo">学号</label>
                                <div class="col-sm-3">
                                    <input type="text" data-validation-engine="required,custom[number]" class="form-control" placeholder="学号" id="stuNo" name="stuNo"/>
                                </div>  
                            </div>
							 <div class="form-group">
                            	 <label class="col-sm-1 control-label no-padding-right" for="reasion">缺勤原因</label>
	                             <div class="col-sm-11">
	                                 <textarea data-validation-engine="validate[required]" class="form-control" id="reasion" name="reasion" placeholder="缺勤原因" style="width: 356px; height: 66px;"></textarea>
	                             </div>
                            </div>		
                            <div class="form-group">
                            ...
                            <input type="hidden" id="type" name="type" value="缺勤">							
                        </form>
