                    ...
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" id="form1" action="index.html" method="post">
                            ...
                            <div class="page-toolbar align-right list-toolbar">
                                <button type="button" class="btn btn-xs btn-inverse btn-xs-ths" id="btnAdd" data-ths-href="goToAddRegisterFroQueQin">
                                        ...
                                        <table id="example" class="table table-striped  table-bordered table-hover">
                                            ...
                                            <tr>
                                               <th class="center">
                                                ...
                                                <th class="align-center">登记日期</th>
                                                <th class="align-center">晚归时间</th>
                                                <th class="align-center">晚归原因</th>
