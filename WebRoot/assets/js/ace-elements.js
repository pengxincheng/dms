...
(function($ , undefined) {
	$.fn.ace_wysiwyg = function($options , undefined) {
		...
		{
			'font' : {
				values:['Arial', 'Courier', 'Microsoft YaHei', '黑体', '宋体', 'sans-serif', 'Verdana'],
				icon:'fa fa-font',
				title:'字体'
			},
			'fontSize' : {
		...
		this.each(function() {
			var toolbar = ' <div class="wysiwyg-toolbar btn-toolbar"><div class="vspace-4"></div> <div class="btn-group "> ';
